...
- **ฟังก์ชัน "จำ" เฉย ๆ ต้องพังแบบเงียบ ๆ ห้ามลากฟีเจอร์หลักลงไปด้วย** — `rememberChatTarget`
  ...
  ในแทบทุกข้อความ) ห่อ try/catch ไว้ในตัวเองหมดแล้ว log แล้วปล่อยผ่าน ไม่ throw ต่อ
  ...
  เจ้าของเกือบถอดบอททิ้งเพราะเรื่องนี้) **ข้อยกเว้นคือ query ที่เป็นการอ่านเพื่อกันข้อมูลรั่วข้ามห้อง**
