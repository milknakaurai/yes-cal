...
| พิมพ์ | ผลลัพธ์ |
|---|---|
| `ตั้งเป้า` | ถามเพศ/อายุ/ส่วนสูง/น้ำหนัก/กิจกรรม → คำนวณ TDEE (Mifflin-St Jeor) ตั้งเป้าแคล + โปรตีนรายวัน |
| `เป้าโปรตีน 140` | ตั้งเป้าโปรตีนเอง (ค่าเริ่มต้นคำนวณจากน้ำหนัก: เพิ่ม 1.8 / ลด 1.6 / คงที่ 1.4 g ต่อ กก.) |
