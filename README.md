...
| (อัตโนมัติ 20:00) | แท็ก @ชื่อ คนที่ยังไม่ออกกำลังกายวันนี้ |
...
| LINE **push** (บอทส่งเอง) | จำกัดต่อเดือน ดูที่ [OA Manager](https://manager.line.biz) | **วันละ 1 ครั้งต่อกลุ่ม** (~30/เดือน) |
